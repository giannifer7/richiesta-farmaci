...
La sezione *Importa da testo* accetta sia il formato riga per riga (con o senza prefissi) che il formato della richiesta (ad es. copiando una richiesta precedente):
